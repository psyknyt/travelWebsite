      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div className="flex flex-col justify-between  items-center gap-5 my-2">
            ...
            <div class="flex mt-4 sm:justify-center sm:mt-0 hover:text-[#1CA8CB]">
          ...
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-6 text-xs font-inter tracking-wider justify-between w-[90%] sm:w-[80%] md:w-fit mx-auto mt-10">
